...
public class EmoticonsText extends TextView {

	public EmoticonsText(Context context) {
		super(context);
	}

	public EmoticonsText(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public EmoticonsText(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
