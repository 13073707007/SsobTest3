...
import com.loongme.util.ApkInstaller;
import com.loongme.util.FucUtil;
import com.loongme.util.JsonParser;

public class AsrDemo extends BaseActivity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * SpeechUtility.createUtility(AsrDemo.this, "appid=" +
	...
	private RecognizerListener mRecognizerListener = new RecognizerListener() {
		...
		public void onResult(final RecognizerResult result, boolean isLast) {
			if (null != result) {
				...
				String test = result.getResultString();
				String text = JsonParser.parseGrammarResult(result.getResultString());
				// 显示
				System.out.println("this is yuyin " + test);
				((EditText) findViewById(R.id.isr_text)).setText(test);
			} else {
