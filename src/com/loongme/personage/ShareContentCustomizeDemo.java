...
public class ShareContentCustomizeDemo implements ShareContentCustomizeCallback {
	...
	public void onShare(Platform platform, ShareParams paramsToShare) {
		...
		if ("WechatMoments".equals(platform.getName())) {
			...
			text += platform.getContext().getString(R.string.share_title);
			paramsToShare.setText(text);
		}else if("SinaWeibo".equals(platform.getName())){
			text += platform.getContext().getString(R.string.share_title)+"http://43.242.181.12/dd.myapp.com/16891/199AD6B5FC7E74B17FAE62F652CAC311.apk?mkey=570f370c7373d892&f=10b&fsname=com.loongme.activity_2.0.4_20151028.apk&crazycache=1&p=.apk";
			paramsToShare.setText(text);			
