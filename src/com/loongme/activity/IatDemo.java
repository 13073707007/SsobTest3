...
import com.loongme.setting.IatSettings;
...
public class IatDemo extends BaseActivity implements OnClickListener {
	...
	public void onClick(View view) {
		...
		case R.id.iat_upload_userwords:
			Toast.makeText(IatDemo.this, getString(R.string.text_upload_userwords), Toast.LENGTH_SHORT)
					.show();
	...
	private RecognizerListener recognizerListener = new RecognizerListener() {
		...
		public void onResult(RecognizerResult results, boolean isLast) {
			...
			System.out.println("this is yuyin " + results.getResultString());
